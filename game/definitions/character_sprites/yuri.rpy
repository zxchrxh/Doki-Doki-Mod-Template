...
# Default Stance (Yandere Expressions)
...
# Right Hand Up (Yandere Expressions)
...
# Both Hands Up (Yandere Expressions)
...
# Looking Away (Special Pose) (Casual Outfit)
