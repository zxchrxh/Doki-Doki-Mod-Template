...
# Glitched Monika - Random chance to appear at the start of act 2 in DDLC, when first entering the literature club
image monika g2:
    block:
        choice:
            "monika/g2.png"
