...
# Default Stance (Special Expressions)
...
# Both Hands on Hip (Special Expressions)
...
# Right Hand on Hip (Casual Outfit)
...
# Left Hand on Hip (Casual Outfit)
...
# Both Hands on Hip (Casual Outfit)
...
# Default Stance (Special Expressions) (Casual Outfit)
...
# Both Hands on Hip (Special Expressions) (Casual Outfit)
...
# Crossing Arms (Special Pose) (Casual Outfit)
